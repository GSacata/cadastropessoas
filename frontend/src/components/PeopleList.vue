                ...
                <table class="w-100">
                    ...
                    <tbody class="container">
                        <tr class="row" v-for="person of people" :key="person.uuid">
                            <td class="col-2 text-center ed-del-cell">
                            ...
                            <td class="col-6 text-start">{{ person.name }}</td>
                            <td class="col-4 text-end">{{ person.document }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
                ...
                <table class="w-100">
                    ...
                    <tbody class="container">
                        <tr class="row" v-for="person of people" :key="person.uuid">
                            ...
                            <td class="col-3 text-end">{{ person.document }}</td>
                            <td class="col-3 text-end">{{ person.email }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
